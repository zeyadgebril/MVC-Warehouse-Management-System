...
namespace Warehouse_Management_System.Controllers
{
    public class ProductController : Controller
    {
        ...
        private void PopulateSupplierDropDownList(object? selectedSupplier = null)
        {
            try
            {
                var suppliers = _unitOfWork.GetSuppliers()
        ...
        public IActionResult BySupplier(int supplierId)
        {
            try
            {
                ...
                var supplier = _unitOfWork.GetSuppliers()
                ...
                var products = _unitOfWork.GetProductsBySupplier(supplierId);
        ...
        private void PopulateCategoryDropDownList(object? selectedCategory = null)
        {
            try
            {
                var categories = _unitOfWork.GetCategories()
