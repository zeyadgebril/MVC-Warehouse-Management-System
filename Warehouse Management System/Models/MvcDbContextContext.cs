...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-S40MU5V8\\SQLEXPRESS;Initial Catalog=MvcDbContext;Integrated Security=True");*/

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryID).HasName("PK__Category__19093A2B699C7C60");
        ...
        {
            entity.HasKey(e => e.LocationID).HasName("PK__Inventor__E7FEA47729C173EB");
        ...
        {
            entity.HasKey(e => new { e.ProductId, e.LocationId }).HasName("PK__Inventor__DA732C847E1A686A");
        ...
        {
            entity.HasKey(e => e.TransactionID).HasName("PK__Inventor__55433A4BBC7FE088");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__B40CC6CDDD480957");
        ...
        {
            entity.HasKey(e => e.HistoryID).HasName("PK__ProductH__4D7B4ADD333FA53A");
        ...
        {
            entity.HasKey(e => e.ReturnID).HasName("PK__Return__F445E988EDE3B5B3");
        ...
        {
            entity.HasKey(e => e.RoleID).HasName("PK__Role__8AFACE3A94455528");
        });

        modelBuilder.Entity<Supplier>(entity =>
        {
            entity.HasKey(e => e.SupplierID).HasName("PK__Supplier__4BE666944E581127");
        });

        modelBuilder.Entity<Supplier_Product>(entity =>
        {
            entity.HasKey(e => new { e.ProductId, e.SupplierID }).HasName("PK__Supplier__E0B2A0A412C9D308");
        ...
        {
            entity.HasKey(e => e.UserID).HasName("PK__User__1788CCAC319AEA47");
        ...
        {
            entity.HasKey(e => e.LogID).HasName("PK__UserLog__5E5499A8D653F4FB");
        ...
        {
            entity.HasKey(e => new { e.UserID, e.RoleID }).HasName("PK__UserRole__AF27604F5B002326");
        ...
        {
            entity.HasKey(e => e.WarehouseID).HasName("PK__Warehous__2608AFD9E85D094A");
        });
